...
import com.tdj_sj_webandroid.bluetooth.adapter.LyFragmentHotelItemAdapter;
...
public class LyGoodsHotelItemActivity extends BaseActivity {
    ...
    TextView right_text;
    public LyFragmentHotelItemAdapter adatper;
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.btn_back:
                ...
                resume.setType("LyGoodsHotelItem");
...
//                }
    ...
    protected void initView() {
        ...
        adatper = new LyFragmentHotelItemAdapter(this.getSupportFragmentManager(), titles);
