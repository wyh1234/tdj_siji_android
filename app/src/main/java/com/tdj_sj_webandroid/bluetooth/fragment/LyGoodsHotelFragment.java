...
import com.tdj_sj_webandroid.bluetooth.adapter.LyGoodsHotelAdapter;
import com.tdj_sj_webandroid.bluetooth.presenter.LyGoodsHotelPresenter;
...
public class LyGoodsHotelFragment extends BaseFrgment<LyGoodsHotelPresenter> {
    @BindView(R.id.ll)
    LinearLayout ll;
    ...
    private LyGoodsHotelAdapter adapter;
    private LyGoodsHotelActivity activity;
    ...
    public static LyGoodsHotelFragment newInstance(int str) {
        Bundle args = new Bundle();
        args.putInt("intent", str);
        LyGoodsHotelFragment f = new LyGoodsHotelFragment();
        f.setArguments(args);
        return f;
    }
    @Override
    protected void initView(View view) {
        ...
        adapter=new LyGoodsHotelAdapter(getActivity(),data);
    ...
    @Override
    protected LyGoodsHotelPresenter loadPresenter() {
        return new LyGoodsHotelPresenter();
    }
    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        LogUtils.e("onAttach");
        if (context instanceof LyGoodsHotelActivity){
            activity=(LyGoodsHotelActivity)context;
        }
