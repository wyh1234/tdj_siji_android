...
import com.tdj_sj_webandroid.bluetooth.adapter.LyFragmentHotelAdapter;
...
public class LyGoodsHotelActivity extends BaseActivity {
    ...
    ImageView btn_back;
    public LyFragmentHotelAdapter adatper;
    ...
    public void onClick(View view){
        switch (view.getId()){
            ...
            case R.id.tv_question:
                Intent intent=new Intent(LyGoodsHotelActivity.this,LyGoodsHotelItemActivity.class);
...
//                }
    ...
    protected void initView() {
        ...
        adatper = new LyFragmentHotelAdapter(this.getSupportFragmentManager(), titles);
