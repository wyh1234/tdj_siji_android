...
public class LyGoodsListAdapter extends BaseRecyclerViewAdapter<GoodsInfo.GoodsListBean>{
    public String title;
    ...
    public LyGoodsListAdapter(Context context, List<GoodsInfo.GoodsListBean> data) {
